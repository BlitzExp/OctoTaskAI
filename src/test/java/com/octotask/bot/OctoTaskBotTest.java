...
public class OctoTaskBotTest {
    ...
    @Mock private GeminiClient geminiAiService;
    @Mock private TelegramClient telegramService;
    ...
    void setUp() {
        ...
        orchestrator = new BotOrchestrator(geminiAiService, telegramService, mockTools, objectMapper);
    }
